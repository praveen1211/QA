...
<script>
	function change1() {
		...
		window.location = "${pageContext.request.contextPath}/TLgetUserName/" + k
				+ "/" + g + ".qa";
	}
...
<section id="body" class="width1 clear">
	...
	<section id="body" class="width clear homeBody"> <section id="content" class="column-right">
	<article>
		...
		<c:if test="${msg=='assign1'}">
			...
			<div class="LoginButton">
				<button type="submit" class="button submit" id="AssignUser"
					...
					formaction="${pageContext.request.contextPath}/TLInsertUserNames.qa">
					<span>SAVE</span>
				</button>
